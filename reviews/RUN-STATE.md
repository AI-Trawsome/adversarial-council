...
5. **NEW — T08 Arm A carve-out verification.** T08's retention is conditional. Must archive the verbatim listing output and prove no reachable mapping decoded the opaque names. If either leg fails, **both T08 arms are re-run.** In progress.
